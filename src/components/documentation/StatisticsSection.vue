<template>
  <section v-show="isActive" id="statistics" class="mb-16">
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Statistics</h1>
      <p class="text-lg text-gray-600 dark:text-gray-400">Endpoints for detailed COVID-19 statistics in Sulawesi Tengah, including gender-based case data, testing statistics, and test types.</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
      <div class="bg-gradient-to-r from-violet-600 to-purple-600 px-8 py-6">
        <div class="flex items-center space-x-3 mb-2">
          ...
          <code class="text-white font-mono text-lg">/api/v1/stats/gender</code>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
      <div class="bg-gradient-to-r from-purple-600 to-fuchsia-600 px-8 py-6">
        <div class="flex items-center space-x-3 mb-2">
          <span class="bg-green-400 text-green-900 text-xs font-bold px-2 py-1 rounded">GET</span>
          <code class="text-white font-mono text-lg">/api/v1/stats/gender/latest</code>
        </div>
    ...
    <!-- Tests -->
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
      <div class="bg-gradient-to-r from-fuchsia-600 to-pink-600 px-8 py-6">
        <div class="flex items-center space-x-3 mb-2">
          <span class="bg-green-400 text-green-900 text-xs font-bold px-2 py-1 rounded">GET</span>
          <code class="text-white font-mono text-lg">/api/v1/stats/tests</code>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
      <div class="bg-gradient-to-r from-pink-600 to-rose-600 px-8 py-6">
        <div class="flex items-center space-x-3 mb-2">
          <span class="bg-green-400 text-green-900 text-xs font-bold px-2 py-1 rounded">GET</span>
          <code class="text-white font-mono text-lg">/api/v1/stats/test-types</code>
        </div>
