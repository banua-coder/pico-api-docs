...
const buttonClasses = computed(() => [
  'flex items-center px-3 py-2 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1',
  {
    'border-gray-200 hover:border-pico-sky bg-white/80 backdrop-blur-sm text-gray-700 hover:text-gray-900': props.variant === 'default',
    'border-gray-200 hover:border-pico-sky bg-white text-gray-700 hover:text-gray-900 min-w-0': props.variant === 'compact'
  }
])

const dropdownClasses = computed(() => [
  'absolute right-0 mt-2 w-32 bg-white border border-gray-200 rounded-lg shadow-lg z-20 py-1',
...
const getOptionClasses = (optionValue: string) => [
  'flex items-center w-full px-3 py-2 text-sm text-left hover:bg-gray-100 transition-colors duration-150 space-x-2',
  'dark:hover:bg-gray-700 dark:text-gray-200',
  {
    'text-blue-600 bg-blue-50 hover:bg-blue-100': theme.value === optionValue,
    'text-gray-700': theme.value !== optionValue
  }
]
