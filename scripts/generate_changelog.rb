...
##
# Automatic Changelog Generator for PICO API Documentation
#
...
#
# Usage:
#   ruby scripts/generate_changelog.rb --version 1.2.3
#   ruby scripts/generate_changelog.rb --version v1.2.3 --force
class ChangelogGenerator
  ...
  def format_changelog_line(commit_info)
    ...
    # Format: "- description (scope if present) (hash)"
...
class CLI
  def self.run(args = ARGV)
    ...
    parser = OptionParser.new do |opts|
      ...
      opts.separator ""
      opts.separator "Automatic Changelog Generator for PICO API Documentation"
      opts.separator ""
    ...
    begin
      ...
      unless options[:version]
        puts "Error: Version is required. Use --version flag or run from a release/hotfix branch."
        puts parser
        exit 1
      end
